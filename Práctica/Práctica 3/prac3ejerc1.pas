...
procedure eliminarEmpleado(var arch: arch_empleados; nom: cadena40);
	var
		reg, aux: empleado;
		pos: integer;
	begin
...
begin
	repeat
		...
		writeln('Ingrese (7) para: Eliminar un empleado específico del archivo de texto.');
		...
		case (option) of
			...
			7:	begin
					writeln('7. ELIMINAR UN EMPLEADO DEL ARCHIVO DE TEXTO');
					writeln;
					reset(archEmpleados);
					write('Ingrese el nombre del empleado a eliminar: ');
					readln(nombre);
					eliminarEmpleado(archEmpleados, nombre);
					writeln;
